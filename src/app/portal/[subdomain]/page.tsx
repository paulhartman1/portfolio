      ...
      <section className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6">
        <div className="flex flex-wrap justify-between gap-4 items-center">
          ...
          <div className="flex flex-wrap gap-3">
            {project.proposal_slug && (
              <Link
                href={`/portal/${subdomain}/proposal/${project.proposal_slug}`}
                className="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-white text-slate-900 font-semibold hover:scale-105 transition-transform"
              >
                View Proposal
