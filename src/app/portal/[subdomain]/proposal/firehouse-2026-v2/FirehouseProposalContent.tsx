  ...
  const pages: ProposalPage[] = [
    ...
    },
    {
      ...
      content: (
        <>
      <h2>Phase One</h2>
      <h3>Public Website Refresh Pilot (v2)</h3>

      <div className="phase-box">
        <p className="investment">Investment: $2,000</p>
        <p className="timeline">
          Estimated Timeline: Approximately 3-4 weeks following approval and receipt of required
          content and deposit.
        </p>
      </div>
      ...
      <h3>Donations</h3>
      <p>Donation integration using existing systems already in operation.</p>
      <p>
        <strong>Including:</strong>
      </p>
      <ul>
        <li>Donation page integration with current forms/workflows</li>
        <li>Improved donor path from public pages to donation flow</li>
        <li>Consistent site styling around donation entry points</li>
        <li>Preservation of existing donation operations in the short term</li>
      </ul>

      <h3>Events & Exhibitions</h3>
      <p>Staff-managed operational tools and public pages for:</p>
      <ul>
        <li>Current exhibitions</li>
        <li>Upcoming events</li>
        <li>Filtered event and exhibit navigation sections</li>
        <li>Exhibition and event details with images</li>
        <li>Targeted admin tools for event/exhibit updates</li>
        <li>Ongoing staff updates without developer involvement in these core areas</li>
      </ul>

      <h3>Artist Membership Applications</h3>
      <p>
        Online applications allowing artists to submit information directly through the website, with
        practical admin workflows for weekly onboarding.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>Add and update member profiles</li>
        <li>Upload member photos</li>
        <li>Maintain the public member gallery</li>
      </ul>

      <h3>Administration</h3>
      <p>
        Secure administrative tools are included for high-frequency operational workflows:
        Events, Exhibits, and Members. This keeps staff self-sufficient in core areas while maintaining
        pilot scope discipline.
      </p>

      <h3>Scope Boundaries (v2)</h3>
      <ul>
        <li>Included: targeted admin tools for Events, Exhibits, and Members</li>
        <li>Included: public redesign, navigation changes, search icon, and content migration</li>
        <li>Not included: full site-wide CMS for all informational pages</li>
        <li>Not included: native e-commerce/shop rebuild (separate enhancement)</li>
        <li>Not included: full replacement of external operational systems in this pilot</li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <span className="checkmark">✓</span> Donation integration with current systems
        </li>
        <li>
          <span className="checkmark">✓</span> Staff-managed events and exhibitions
        </li>
        <li>
          <span className="checkmark">✓</span> Staff-managed member onboarding and gallery updates
        </li>
        <li>
          <span className="checkmark">✓</span> A focused pilot foundation for broader platform work
        </li>
      </ul>
        </>
      ),
    ...
    },
    {
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Public Website Refresh Pilot (v2)</td>
            <td>$2,000</td>
          </tr>
          <tr>
  ...
  return (
    <div className="proposal-container">
      ...
      <div className="title-section">
        <h1>Digital Transformation Proposal (v2)</h1>
        ...
        <div style={{ marginTop: '3em' }}>
          ...
          <p className="meta">July 2026 (Revised July 10, 2026)</p>
        </div>
      </div>
